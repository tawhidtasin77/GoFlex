...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Save email temporarily so page refresh doesn't lose it
        ...
        >
          ...
          <div className="mb-5">
            ...
            <input
              ...
              autoComplete="name"
              disabled={loading}
              className="w-full rounded-lg border border-zinc-700 bg-zinc-800 px-4 py-3 text-white outline-none placeholder:text-zinc-500 focus:border-orange-500 focus:ring-1 focus:ring-orange-500 disabled:cursor-not-allowed disabled:opacity-60"
            />
          </div>

...
const PaymentCancel = () => {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-zinc-950 px-5 py-10 text-white">
      <div className="w-full max-w-lg rounded-3xl border border-yellow-500/20 bg-zinc-900 p-8 text-center shadow-2xl sm:p-10">
        
        <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-yellow-500/10">
          <div className="flex h-14 w-14 items-center justify-center rounded-full bg-yellow-500 text-2xl font-bold text-zinc-950">
            !
          </div>
        </div>
        ...
        <p className="mt-4 leading-7 text-zinc-400">
          You cancelled the payment process. No payment has been completed for
          this order.
        </p>
